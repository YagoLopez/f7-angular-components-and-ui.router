...
app.angular.config( function($provide, $compileProvider, $httpProvider, $stateProvider, $routeProvider, $logProvider,
  ...
  $stateProvider.state(
    '/', {url:'/', template: '<pag-home></pag-home>'});
  $stateProvider.state(
    'listPage', {url:'/listPage', template: '<pag-search-list></pag-search-list>'});
  $stateProvider.state(
    'helpPage', {url:'/helpPage', template: '<pag-help></pag-help>'});
  $stateProvider.state(
    'tabsPage', {url:'/tabsPage', template: '<pag-tabs></pag-tabs>'});
  $stateProvider.state(
    'pagSwiper', {url:'/swiperPage', template: '<pag-swiper></pag-swiper>'});
  $stateProvider.state(
    'pagLazyLoad', {url:'/pagLazyLoad', template: '<pag-lazy-load></pag-lazy-load>'});
  $stateProvider.state(
    'pagVirtualList', {url:'/pagVirtualList', template: '<pag-virtual-list></pag-virtual-list>'});
  $stateProvider.state(
    'pagInfiniteScroll', {url:'/pagInfiniteScroll', template: '<pag-infinite-scroll></pag-infinite-scroll>'});
  $stateProvider.state(
    'pagPhotoBrowser', {url:'/pagPhotoBrowser', template: '<pag-photo-browser></pag-photo-browser>'});
  $stateProvider.state(
    'pagGrid', {url:'/pagGrid', template: '<pag-grid></pag-grid>'});
